...
import {
  ...
  InputGroupButton,
  InputGroupInput,
} from "@logitrack/ui/components/input-group"
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      render={(props) => <InputGroupButton variant="ghost" size="icon-xs" {...props} />}
  ...
  return (
    <InputGroup className={cn("w-auto", className)}>
      <ComboboxPrimitive.Input
        render={(props) => <InputGroupInput disabled={disabled} {...props} />}
        {...props}
      />
    ...
    >
      ...
      {showRemove && (
        <ComboboxPrimitive.ChipRemove
          render={(props) => <Button variant="ghost" size="icon-xs" {...props} />}
